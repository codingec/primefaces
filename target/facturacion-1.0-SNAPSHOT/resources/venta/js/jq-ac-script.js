$(document).ready(function(){
    ...
    $('#itemCode').autocomplete({
        ...
        select: function(event, ui) {
            var $itemrow = $(this).closest('tr');
                    ...
                    $itemrow.find('#token').val(ui.item.token   );
    ...
    var rowTemp = [
        '<tr class="item-row">',
            ...
            '<td><input type="hidden" name="token[]" class="tInput" value="" id="token"  /></td>',
            '<td><input name="itemPrice[]" class="tInput" value="" id="itemPrice" /></td>',
            '<td><input type="number" name="itemQty[]" class="tInput" value="1" id="itemQty" /></td>',
